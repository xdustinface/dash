...
public:
    ...
    const std::string strUnableToLocatePrivateSend1 = "Unable to locate enough CoinJoin non-denominated funds for this transaction.";
    const std::string strUnableToLocatePrivateSend2 = "Unable to locate enough CoinJoin denominated funds for this transaction. CoinJoin uses exact denominated amounts to send funds, you might simply need to mix some more coins.";
