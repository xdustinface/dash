...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "init -> coinjoin/coinjoin-server -> init"
    ...
    "net_processing -> coinjoin/coinjoin-server -> net_processing"
    ...
    "init -> masternode/masternode-utils -> coinjoin/coinjoin-client -> init"
    ...
    "llmq/quorums_chainlocks -> net -> coinjoin/coinjoin -> llmq/quorums_chainlocks"
    ...
    "llmq/quorums_instantsend -> wallet/wallet -> coinjoin/coinjoin -> llmq/quorums_instantsend"
    "llmq/quorums_instantsend -> net_processing -> coinjoin/coinjoin-server -> llmq/quorums_instantsend"
    ...
    "masternode/activemasternode -> net -> coinjoin/coinjoin -> masternode/activemasternode"
    "masternode/masternode-payments -> net_processing -> coinjoin/coinjoin-client -> masternode/masternode-payments"
    "masternode/masternode-sync -> net -> coinjoin/coinjoin -> masternode/masternode-sync"
    "net -> coinjoin/coinjoin -> spork -> net"
    ...
    "core_io -> evo/cbtx -> llmq/quorums_blockprocessor -> net -> coinjoin/coinjoin -> core_io"
    "core_io -> evo/cbtx -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-client -> core_io"
    "core_io -> evo/cbtx -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-server -> core_io"
    "evo/deterministicmns -> evo/simplifiedmns -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-client -> evo/deterministicmns"
    ...
    "evo/deterministicmns -> evo/simplifiedmns -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-server -> masternode/activemasternode -> evo/deterministicmns"
    "evo/providertx -> evo/specialtx -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-server -> masternode/activemasternode -> evo/providertx"
    "evo/providertx -> evo/specialtx -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-client -> coinjoin/coinjoin-util -> wallet/wallet -> evo/providertx"
    "core_io -> evo/cbtx -> llmq/quorums_blockprocessor -> net_processing -> coinjoin/coinjoin-client -> coinjoin/coinjoin-util -> wallet/wallet -> governance/governance-object -> core_io"
)
